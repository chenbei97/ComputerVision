#include "charter5_bidirectIterator.h"
#include <iostream>
void _charter5_bidirectional_iterator()
{
	// 把类的实现和声明写在1个头文件就可以直接使用了
	_charter5_bidirectIterator<int> iterator;
	int x[5] = { 3,7,9,2,6 };
	int count = 0;
	...
	_charter5_bidirectIterator<int>* piterator = &iterator;
