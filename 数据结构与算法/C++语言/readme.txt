...
-----------2022.1.14-------------
上午完成了数组描述的栈，2种方式，基于数组线性表具体类的派生和基于抽象栈类的直接实现。
下午基于链表描述的栈，也可以使用2种方式，基于链表具体类chain和基于抽象栈类的直接实现，这里只给出直接实现，派生类基于性能不在给出
今天该发工资了吧！！

-----------2022.1.17-------------
玩了两天英雄联盟没学习，累了，今天上班把第八章的栈结束了，主要是括号匹配和汉诺塔问题，其它的栈应用比较困难~~看不懂跳过了
