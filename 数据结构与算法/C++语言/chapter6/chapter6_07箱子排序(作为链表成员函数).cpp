#include "chapter6_chainListIterator_binSort.h"
#include "chapter6_studentRecord2.h"
void _chapter6_StudentRecord2_binSort_testCode()
{
    typedef _chapter6_studentRecord2 stu;
    typedef _chapter6_chainBinSort<stu> chain;
    stu s;
    chain theChain;
